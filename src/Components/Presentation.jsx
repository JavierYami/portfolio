...
const Presentation = () => {
    ...
    return (
        <header className="container mx-auto text-white pt-20 w-6/12 text-center">
            <h1 className="text-5xl font-medium mb-5"> Javier Rivera</h1>
            <h3 className="text-3xl font-light mb-5"> Full Stack Web Developer</h3>
